...
x:e.x
}),console.log("up dragging",o.dragTime),t.barDraging=!1,this.player.seek(o.dragTime),
C.reportData[this._o.type].seek[t.posIndex]=1,C.reportData[this._o.type].seek_position[t.posIndex].push(parseInt(1e3*o.startTime)+","+parseInt(1e3*o.dragTime));
...
});define("appmsg/reward_entry.js",["biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","rt/appmsg/getappmsgext.rt.js","biz_wap/utils/mmversion.js"],function(e,t,n,r){
"use strict";
function i(e){
...
rtDesc:f,
success:function(e){
e&&(document.getElementById("js_reward_link")&&p.off(document.getElementById("js_reward_link"),"click",j),
s({
...
function s(e){
var t=window.innerWidth||document.documentElement.innerWidth,n=(Math.ceil((v-188)/42)+1)*Math.floor((t-15)/42);
w="http://mp.weixin.qq.com/mp/reward?act=getrewardheads&__biz="+biz+"&appmsgid="+mid+"&idx="+idx+"&sn="+sn+"&offset=0&count="+n+"&source=1#wechat_redirect";
var r="#wechat_redirect",s="";
s=source_mid&&source_biz&&source_idx?"https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz="+source_encode_biz+"&appmsgid="+source_mid+"&idx="+source_idx+"&reprint_biz="+biz+"&reprint_appmsgid="+mid+"&reprint_idx="+idx+"&timestamp="+e.timestamp+"&scene=141#wechat_redirect":"https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz="+biz+"&appmsgid="+mid+"&timestamp="+e.timestamp+"&idx="+idx+"&scene=142#wechat_redirect",
-1!=navigator.userAgent.indexOf("Android")&&(s="https://mp.weixin.qq.com/bizmall/reward?act=showpage&__biz="+biz+"&appmsgid="+mid+"&idx="+idx+"&sn="+sn+"&timestamp="+e.timestamp+"&s    howwxpaytitle=1"+r);
...
if(-1!=navigator.userAgent.indexOf("Android")&&localStorage.getItem("lastOnresumeTime")&&t-parseInt(localStorage.getItem("lastOnresumeTime"))<=y)return;
localStorage.setItem("lastOnresumeTime",t),g.invoke("setNavigationBarColor",{
actionCode:"1"
}),o();
}
}),j=d(s),p.on(m,"click",j),h.isIOS&&1==e.can_reward)){
m.setAttribute("class","reward_button"),i(document.getElementById("js_reward_author")),
i(document.getElementById("js_reward_avatar"));
var _=document.getElementById("js_reward_link_text");
_.innerText="赞作者";
}
b=e.reward_head_imgs;
var u=c();
x.reward&&1==e.can_reward?(i(x.reward),p.on(window,"load",function(){
l&&(p.off(window,"scroll",l),p.on(window,"scroll",l));
})):a(x.reward);
var f=document.getElementById("js_reward_inner");
f&&u>0&&i(f);
var z=document.getElementById("js_reward_total");
z&&(z.innerText=e.reward_total,z.setAttribute("href",w));
}
function m(e,t){
...
if(e){
for(var r=0,i=b.length;i>r&&(t++,m(n,b[r]),t!=3*_);++r);
t>_&&(e.className+=" tl"),e.innerHTML="",e.appendChild(n);
}
return t;
}
}
...
e+v>x.reward.offsetTop&&(u({
type:"GET",
url:"/bizmall/reward?act=report&__biz="+biz+"&appmsgid="+mid+"&idx="+idx,
async:!0
}),p.off(window,"scroll",l),l=null);
}
var _,w,p=e("biz_common/dom/event.js"),u=e("biz_wap/utils/ajax.js"),g=e("biz_wap/jsapi/core.js"),f=e("rt/appmsg/getappmsgext.rt.js"),h=e("biz_wap/utils/mmversion.js"),v=window.innerHeight||document.documentElement.clientHeight,x={
